...
const TodoCreate = ({createTodo}:{createTodo:any}) => {
  ...
  return (
    <form onSubmit={handleSubmitAddTodo} className="dark:bg-gray-800 transition-all duration-1000 bg-white rounded-md overflow-hidden py-4 flex gap-4 items-center px-4">
